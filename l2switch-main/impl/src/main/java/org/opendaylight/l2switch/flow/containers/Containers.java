...
public class Containers {
    ...
    private DockerCalls docker = new DockerCalls();
    ...
    */
    ...
    public void restartContProcess(String cont_name) {
	docker.restartContProcess(this.remoteIP, this.remoteDockerPort, cont_name);
    }    
